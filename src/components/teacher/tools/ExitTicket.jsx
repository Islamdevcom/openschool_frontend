...
function ExitTicket({ isOpen, onClose }) {
    ...
    const sampleQuestions = {
        '3questions': [
            { label: '1. Что я понял на уроке?', placeholder: '' },
            { label: '2. Что мне было непонятно?', placeholder: '' },
            { label: '3. Что я хочу узнать больше?', placeholder: '' }
        ],
        'quick': [
            { label: '1. Назовите главную идею урока', placeholder: '' },
            { label: '2. Приведите пример по теме', placeholder: '' },
            { label: '3. Какое правило вы запомнили?', placeholder: '' }
        ],
        'reflection': [
            { label: '1. Что нового я узнал сегодня?', placeholder: '' },
            { label: '2. Как я могу применить это в жизни?', placeholder: '' },
            { label: '3. Оцените свою работу на уроке (1-5)', placeholder: '' }
        ],
        'custom': [
            { label: '1. Ваш вопрос', placeholder: '' },
            { label: '2. Ваш вопрос', placeholder: '' },
            { label: '3. Ваш вопрос', placeholder: '' }
        ]
    };
                                ...
                                {[1, 2].map(ticketNum => (
                                    <div key={ticketNum} className="ticket-card">
                                        ...
                                        <div className="ticket-questions">
                                            {sampleQuestions[formData.format].map((q, idx) => (
